...
|---|---|---|---|---|
| **Mac**     | direct | ✅ 210.107.188.8 | ⚠️ Win | ✅ 138.2.14.219 |
| **Ubuntu**  | ✅ 203.247.167.58 | direct | ⚠️ Win | ✅ 138.2.14.219 |
| **Windows** | ⚠️ Win | ⚠️ Win | direct | ⚠️ Win |
| **Oracle**  | ✅ 118.235.x | ✅ 210.107.188.8 | ⚠️ Win | direct |
...
(203.247.167.58), so those two exits share an egress IP — the `exit use <id>`
